...
export default {
  ...
  computed: {
    ...
    email:{
      // getter
      get: function () {
          return this.$store.state.user.temp_email;
      },
      // setter
      set: function (newValue) {
          this.$store.state.user.temp_email = newValue;
      }
    },
    token:{
      // getter
      get: function () {
        console.log(this.$store.state.user.temp_token)
          return this.$store.state.user.temp_token;
      },
      // setter
      set: function (newValue) {
          this.$store.state.user.temp_token = newValue;
      }
    },
  },
  methods: {
